...
2) Go to the `Data Science Projects` section and access your application's project named `model2-apr29-1`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot2-apr29-2-notebook`.
...
5) In the terminal, run `cd chatbot2-apr29-2` to navigate to your sample app's directory.
